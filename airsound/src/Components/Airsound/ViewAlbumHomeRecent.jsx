...
const ViewAlbumHomeRecent = ()=>{
    ...
    useEffect(()=>{
fetchData("N.E.R.D").then(data=>{setAlbum1(data);setIsLoad1(true)});
fetchData("Shakira").then(data=>{setAlbum2(data);setIsLoad2(true)});
fetchData("fedez").then(data=>{setAlbum3(data);setIsLoad3(true)});
fetchData("Ultimo").then(data=>{setAlbum4(data);setIsLoad4(true)});
    },[])
